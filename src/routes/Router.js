...
const ThemeRoutes = [
  {
    ...
    children: [
      ...
      {path: "/note-boardgames-react/notes/:id", exact: true, element: <Note/>},
      {path: "/games", exact: true, element: <Games/>},
      {path: "/games/:id", exact: true, element: <Game/>},
      {path: "/games/:title", exact: true, element: <Game/>},
      {path: "/note-boardgames-react/games/:id", exact: true, element: <Game/>},
      {path: "/note-boardgames-react/games/:title", exact: true, element: <Game/>},
